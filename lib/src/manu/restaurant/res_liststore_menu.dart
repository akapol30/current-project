...
import 'package:project_towin/src/manu/restaurant/res_addmenu_north.dart';
import 'package:project_towin/src/manu/restaurant/res_detail.dart';

//import 'package:project_towin/src/modelclass/list_food.dart';
...
class ResListStoreMenu extends StatefulWidget {
  final Widget categories;
  const ResListStoreMenu({Key? key, required this.categories})
      : super(key: key);

  @override
  State<ResListStoreMenu> createState() => _ResListStoreMenuState();
}

class _ResListStoreMenuState extends State<ResListStoreMenu> {
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return SlidingUpPanelExampleRes(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("ร้านภาคเหนือ", style: TextStyle(fontFamily: 'Mitr')),
        centerTitle: true,
      ),
      body: SafeArea(
