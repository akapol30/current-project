...
class TravelConverseNorth extends StatefulWidget {
  const TravelConverseNorth({super.key});

  @override
  State<TravelConverseNorth> createState() => _TravelConverseNorthState();
}

class _TravelConverseNorthState extends State<TravelConverseNorth> {
