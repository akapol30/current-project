...
class BookListDessertMenu extends StatefulWidget {
  final Widget categories;
  const BookListDessertMenu({Key? key, required this.categories})
      : super(key: key);

  @override
  State<BookListDessertMenu> createState() => _BookListDessertMenuState();
}

class _BookListDessertMenuState extends State<BookListDessertMenu> {
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Center(
                                  //child: Image.network(food.pic[0]),
                                  ),
                            ),
                            const SizedBox(
                              width: 15,
